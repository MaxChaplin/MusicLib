...
public:
    ...
    // template <typename D>
    // std::unique_ptr<D> clone() const = delete;
...
// template<>
// std::unique_ptr<Instrument> InstrumentMono::clone<Instrument>() const;

// template<>
// std::unique_ptr<Instrument> InstrumentPoly::clone<Instrument>() const;
